...
public class Menu {
	 ...
	 * @param unchosenText
	 */
	public Menu(String title, int numOptions, String[] options, boolean exitAllowed, int exitOn, String exitText, boolean incompleteExit, String chosenText, String unchosenText) {
		choice = -1;
		lastChoice = -1;
		
		this.exitAllowed = exitAllowed;
		this.exitOn = exitOn;
		this.incompleteExit = incompleteExit;
	...
	//Test constructors below this line\\
	...
	public Menu(String title, int numOptions, String[] options, boolean exitAllowed, int exitOn, String exitText) {
		this(title, numOptions, options, exitAllowed, exitOn, exitText, true, null, null);
	}
	 ...
	 * @param unchosenText
	 */
	public Menu(String title, int numOptions, String[] options, boolean incompleteExit, String chosenText, String unchosenText) {
		this(title, numOptions, options, false, 0, null, incompleteExit, chosenText, unchosenText);
	}
	 ...
	 * @param unchosenText
	 */
	public Menu(String title, String[] options, boolean incompleteExit, String chosenText, String unchosenText) {
		this(title, options.length, options, incompleteExit, chosenText, unchosenText);
	}
	...
	public Menu(String title, int numOptions, String[] options) {
		this(title, numOptions, options, false, 0, null, true, null, null); //eventually change this to one of the shorter constructor calls?
	}
	...
	public boolean canIncompleteExit() {
		return incompleteExit;
	}
	
	public Menu setIncompleteExit(boolean allowed) {
		incompleteExit = allowed;
		return this;
	}
